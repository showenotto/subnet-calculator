    ...
    rsx! {
        div { class: "w-full h-full bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 flex flex-col",
            ...
            div { class: "mb-6",
                ...
                input {
                    class: "w-full px-4 py-3 text-base text-base border rounded-lg dark:bg-gray-700",
                    r#type: "text",
            ...
            div { class: "mb-6",
                ...
                select {
                    class: "w-full px-4 py-3 pr-10 text-base border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none",
            ...
            if is_by_subnets {
                div { class: "mb-6",
                    ...
                    input {
                        r#type: "number",
                        min: "1",
                        class: "w-full px-4  text-base py-3 border rounded-lg dark:bg-gray-700",
                        placeholder: "e.g. 100",
                        value: "{count_input}",
            ...
            if is_by_prefix {
                div { class: "mb-6",
                    ...
                    input {
                        ...
                        min: "1",
                        max: "64",
                        class: "w-full text-base  px-4 py-3 border rounded-lg dark:bg-gray-700",
                        placeholder: "e.g. 64",
            ...
            if is_by_hierarchy {
                div { class: "mb-6",
                    ...
                    button {
                        class: "mb-4 bg-green-500  text-base px-4 py-2 rounded",
                    ...
                    for (i, level) in hierarchy_levels.read().iter().enumerate() {
                        div { class: "mb-4 border p-4 rounded",
                            input {
                                class: "w-full text-sm  mb-2 px-4 py-2 border",
                    ...
                    button {
                        class: "mt-2 text-base bg-red-500  px-4 py-2 rounded",
